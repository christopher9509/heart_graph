...
from models.pygcnII import GCN
from models.pygcnII import MyEnsemble
...
def get_training_args():
    ...
    gcn_config = {
        ...
        "num_of_layers": 5,  # PPI has got 42% of nodes with all 0 features - that's why 3 layers are useful
        "num_features_per_layer": [34, 16, 1],  # 64 would also give ~0.975 uF1!
        "alpha" : 0.2, # hyperparameter
        "lamda" : 0.5, # hyperparameter
