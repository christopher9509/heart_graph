...
class MyEnsemble(nn.Module):
    def __init__(self, gat0, gat1, gat2, num_features_per_layer):
        ...
        self.gat1 = gat1
        self.gat2 = gat2
        self.out_feat = num_features_per_layer[2]
...
#         self.node_features2 = node_features2
    ...
    def forward(self, node_features0, node_features1, node_features2, edge_index):
     
        head1 = self.gat0((node_features0, edge_index))
        head2 = self.gat1((node_features1, edge_index))
        head3 = self.gat2((node_features2, edge_index))
        ...
        #cat_head = torch.cat((head1, head2, head3), 1)
#         print("="*40)
#         print(head1)
#         print("="*40)
#         print(head2)
...
# class FC1(nn.Module):
#     def __init__(self, main_output, BFR):
#         super(FC1, self).__init__()

        
#         self.classifier = nn.Linear(96, 1)
        
#     def forward(self, main_output, BFR):
        
#         BFR = torch.squeeze(BFR, 0)
        
#         x = torch.cat((main_output, BFR), dim=1)
#         x2 = self.classifier(x)
...
class GAT(torch.nn.Module):
    ...
    def __init__(self, num_of_layers, nfeat, num_heads_per_layer, num_features_per_layer, add_skip_connection=True, bias=True,
        ...
        gat_layers1 = []  # collect GAT layers
        gat_layers2 = []
        ...
        self.sc2 = GatedSkipConnection(nfeat, num_features_per_layer[2])
        
        gat_layers1.append(layer0)
        #gat_layers.append(layer1)
        gat_layers2.append(layer2)
        
        self.dropout = nn.Dropout(0.5)
        
        self.gat_net1 = nn.Sequential(*gat_layers1)
        self.gat_net2 = nn.Sequential(*gat_layers2)
    ...
    def forward(self, x):
        ...
        out1, adj_1 = self.gat_net1(x)
        
        out2 = self.sc1(residual, out1)
        
        out3 = F.relu(out2)
        
        out3 = out3, adj_1
        
        out4, adj_2 = self.gat_net2(out3)    

        out5 = self.sc2(residual, out4)
        out6 = F.relu(out5)
